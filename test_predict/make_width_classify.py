...
save_file_path = os.path.join(os.pardir, os.pardir, 'wb_data', 'middle_data', 'test_data_same_list.txt')
weibo_classify_save_file_path = os.path.join(os.pardir, os.pardir, 'wb_data', 'classify_data', 'weibo_width_classify_data.txt')
...
def get_classify_dict(data_dict, test_dict, length, low_gap, high_gap, min_gap, min_num, classify_number):
    ...
    for test_weibo_id in test_dict:
        ...
        generate_classify.make_classify(test_list, predict_list, same_weibo_id_set, data_dict,
                                        weibo_id_classify, classify_number)
